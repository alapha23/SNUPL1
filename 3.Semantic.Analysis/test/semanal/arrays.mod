...
procedure p1(A,B: integer[5]; C: integer[5][5][5]); // pass
var i: integer;
    c: char;
    b: boolean;
    X,Y: integer[5];
...
procedure p2(a: integer[5][5][5]);  // pass
...
function strcpy(src, dst: char[10]): integer; // pass
var res10: char[10];
    res5 : char[5];
begin
  //return res10;                   // fail
